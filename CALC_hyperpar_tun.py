...
if __name__ == "__main__":
    ...
    from CALC_algorithms import links, similarity_matrix, rock
    ...
    def safe_tables(input_data: str, stop: bool) -> None:
        ...
        perf_table.to_csv(
            f"C:\\Users\\yann-\\Documents\\03_Education\\03.1_CAS-MachineLearning\\XX_Workspaces\\211202_CAS-MS\\134_{timestamp}_{name}_perftable.csv"
        )

        # clustertable.to_csv(
        # f"C:\\Users\\yann-\\Documents\\03_Education\\03.1_CAS-MachineLearning\\XX_Workspaces\\211202_CAS-MS\\134_{timestamp}_{name}_clustertable.csv"
        # )

        # red_clustertable.to_csv(
        # f"C:\\Users\\yann-\\Documents\\03_Education\\03.1_CAS-MachineLearning\\XX_Workspaces\\211202_CAS-MS\\134_{timestamp}_{name}_red-clustertable.csv"
        # )
        if stop is True:
            sys.exit()
        else:
